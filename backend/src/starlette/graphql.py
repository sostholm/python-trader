      ...
      function graphQLFetcher(graphQLParams) {
        ...
        return fetch({{REQUEST_PATH}}, {
          ...
          headers: {
            ...
            'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDY2NzM0ODQsImlkIjoiNWYyNDgwNGU0YWU5NThhMjZjMmUyNjliIn0.nkT7rI8Oy_v1TnkwzvWCGqWheifs0LzeRS9LUDYMzTY'
          },
